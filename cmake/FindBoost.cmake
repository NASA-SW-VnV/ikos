...
if (NOT Boost_NO_BOOST_CMAKE)
  ...
  if (Boost_FOUND)
    message("Found Boost: ${Boost_DIR} (found version \"${Boost_FIND_VERSION}\")")
...
if(Boost_FOUND)
  if(NOT Boost_FIND_QUIETLY)
    message(STATUS "Found Boost: ${Boost_INCLUDE_DIRS} (found version \"${Boost_MAJOR_VERSION}.${Boost_MINOR_VERSION}.${Boost_SUBMINOR_VERSION}\")")
    if(Boost_FIND_COMPONENTS)
