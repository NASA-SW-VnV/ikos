...
if (NOT APRON_FOUND)
  ...
  find_package_handle_standard_args(APRON
    REQUIRED_VARS APRON_INCLUDE_DIR APRON_APRON_LIB GMP_FOUND MPFR_FOUND
    FAIL_MESSAGE "Could NOT find APRON. Please provide -DAPRON_ROOT=<apron-directory>")

  set(APRON_INCLUDE_DIR ${APRON_INCLUDE_DIR}
    ${GMP_INCLUDE_DIR} ${GMPXX_INCLUDE_DIR}
    ${MPFR_INCLUDE_DIR} ${PPL_INCLUDE_DIR})

  set(APRON_LIBRARIES ${APRON_APRON_LIB} ${APRON_BOX_LIB} ${APRON_ITV_LIB}
    ${APRON_BOX_LIB} ${APRON_OCT_LIB} ${APRON_OCT_LIB} ${APRON_POLKA_LIB}
    ${APRON_PPL_LIB} ${APRON_PKGRID_LIB}
    ${GMP_LIB} ${GMPXX_LIB} ${MPFR_LIB} ${PPL_LIB})

  mark_as_advanced(APRON_INCLUDE_DIR APRON_LIBRARIES APRON_APRON_LIB
    APRON_BOX_LIB APRON_ITV_LIB APRON_BOX_LIB APRON_OCT_LIB APRON_OCT_LIB
