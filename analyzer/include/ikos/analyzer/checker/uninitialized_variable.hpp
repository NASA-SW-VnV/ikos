 ...
 *
 * \file
 * \brief Uninitialized variable checker
 *
...
/// \brief Uninitialized variable checker
class UninitializedVariableChecker final : public Checker {
public:
  /// \brief Constructor
  explicit UninitializedVariableChecker(Context& ctx);
...
}; // end class UninitializedVariableChecker
