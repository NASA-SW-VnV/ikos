...
FunctionFixpoint::FunctionFixpoint(
    ...
    : FwdFixpointIterator(entry_point->body(), make_bottom_abstract_value()),
      _ctx(ctx),
      ...
      _checkers(checkers),
      _logger(logger),
      _exec_engine(make_bottom_abstract_value(),
                   ctx,
                   this->_call_context,
...
FunctionFixpoint::FunctionFixpoint(Context& ctx,
                                   ...
                                   ar::Function* callee,
                                   bool context_stable)
    : FwdFixpointIterator(callee->body(), make_bottom_abstract_value()),
      _ctx(ctx),
      _function(callee),
      _call_context(
