...
class LowerCstExprPass : public llvm::ModulePass {
private:
  bool runOnFunction(llvm::Function& F);

  llvm::ConstantExpr* hasCstExpr(llvm::Value* Value);

  llvm::Instruction* lowerCstExpr(llvm::ConstantExpr* CEx,
                                  llvm::Instruction* I);
...
#endif // IKOSPP_LOWER_CST_EXPR_HPP
