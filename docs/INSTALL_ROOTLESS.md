...
You will need a **C/C++ compiler**. The version of the compiler does not matter. If you have an old compiler that does not support C++ 14, the script will automatically download, build and install **gcc 7.2.0**.
...
```
$ cd /path/to/ikos-build/ikos-1.3
$ make test
```
