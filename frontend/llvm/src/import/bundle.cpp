...
ar::Function* BundleImporter::translate_function(llvm::Function* fun) {
  ...
  } else if (!fun->isDeclaration() && fun->getName().startswith("__clang_")) {
...
ar::Function* BundleImporter::translate_intrinsic_function(
  ...
  } else if (id == llvm::Intrinsic::fabs || id == llvm::Intrinsic::bswap ||
             id == llvm::Intrinsic::pow || id == llvm::Intrinsic::objectsize ||
