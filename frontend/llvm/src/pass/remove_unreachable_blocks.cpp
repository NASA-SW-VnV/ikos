 ...
 *
 * \file
 * \brief Implementation of the RemoveUnreachableBlocksPass
 *
...
struct RemoveUnreachableBlocksPass final : public FunctionPass {
...
}; // end struct RemoveUnreachableBlocksPass

} // end anonymous namespace

char RemoveUnreachableBlocksPass::ID = 0;

INITIALIZE_PASS(RemoveUnreachableBlocksPass,
