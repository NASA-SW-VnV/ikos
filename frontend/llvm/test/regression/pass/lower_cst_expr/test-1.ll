...
; CHECK:  store i32 %arg_1, ptr %_2, align 4
; CHECK:  store ptr %arg_2, ptr %_3, align 8
; CHECK:  %_7 = bitcast ptr %_4 to ptr
; CHECK:  call void @llvm.memset.p0.i64(ptr align 16 %_7, i8 0, i64 20, i1 false)
; CHECK:  %_8 = getelementptr inbounds %struct.foo, ptr %_5, i32 0, i32 0
; CHECK:  store i32 59, ptr %_8, align 4
; CHECK:  %_9 = load i32, ptr @x, align 4
; CHECK:  %_10 = add nsw i32 %_9, 1
; CHECK:  store i32 %_10, ptr @x, align 4
; CHECK:  %0 = getelementptr inbounds [10 x i32], ptr @B, i64 0, i64 8
; CHECK:  store i32 23, ptr %0, align 16
; CHECK:  %_11 = load i32, ptr @x, align 4
; CHECK:  %_12 = add nsw i32 %_11, 7
; CHECK:  %_13 = getelementptr inbounds %struct.foo, ptr %_5, i32 0, i32 0
; CHECK:  %_14 = load i32, ptr %_13, align 4
; CHECK:  %_15 = add nsw i32 %_12, %_14
; CHECK:  %_16 = getelementptr inbounds [5 x i32], ptr %_4, i64 0, i64 4
; CHECK:  %_17 = load i32, ptr %_16, align 16
; CHECK:  %_18 = add nsw i32 %_15, %_17
; CHECK:  %1 = getelementptr inbounds [10 x i32], ptr @B, i64 0, i64 9
; CHECK:  %_19 = load i32, ptr %1, align 4
; CHECK:  %_20 = add nsw i32 %_18, %_19
; CHECK:  store i32 %_20, ptr %_6, align 4
; CHECK:  %_21 = load i32, ptr %_6, align 4
; CHECK:  ret i32 %_21
bb_1:
