...
; CHECK:  store i32 1, ptr @p, align 16
; CHECK:  %0 = getelementptr inbounds [2 x [2 x [2 x i32]]], ptr @p, i64 0, i64 0, i64 0, i64 1
; CHECK:  store i32 1, ptr %0, align 4
; CHECK:  %1 = getelementptr inbounds [2 x [2 x [2 x i32]]], ptr @p, i64 0, i64 0, i64 1, i64 0
; CHECK:  store i32 1, ptr %1, align 8
; CHECK:  %2 = getelementptr inbounds [2 x [2 x [2 x i32]]], ptr @p, i64 0, i64 0, i64 1, i64 1
; CHECK:  store i32 1, ptr %2, align 4
; CHECK:  %3 = getelementptr inbounds [2 x [2 x [2 x i32]]], ptr @p, i64 0, i64 1, i64 0, i64 0
; CHECK:  store i32 1, ptr %3, align 16
; CHECK:  %4 = getelementptr inbounds [2 x [2 x [2 x i32]]], ptr @p, i64 0, i64 1, i64 0, i64 1
; CHECK:  store i32 1, ptr %4, align 4
; CHECK:  %5 = getelementptr inbounds [2 x [2 x [2 x i32]]], ptr @p, i64 0, i64 1, i64 1, i64 0
; CHECK:  store i32 1, ptr %5, align 8
; CHECK:  %6 = getelementptr inbounds [2 x [2 x [2 x i32]]], ptr @p, i64 0, i64 1, i64 1, i64 1
