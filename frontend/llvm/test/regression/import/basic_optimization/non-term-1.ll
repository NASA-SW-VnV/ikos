...
; <label>:6:                                      ; preds = %3
  ...
  call void @llvm.dbg.value(metadata i32 %7, metadata !20, metadata !DIExpression()), !dbg !21
  br label %3, !dbg !19, !llvm.loop !28
}
...
!20 = !DILocalVariable(name: "i", scope: !8, file: !1, line: 4, type: !11)
...
!29 = !DILocation(line: 9, column: 3, scope: !8)
