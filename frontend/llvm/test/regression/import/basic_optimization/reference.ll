...
define i32 @main() #2 !dbg !17 {
  ...
  call void @llvm.dbg.declare(metadata i32* %1, metadata !20, metadata !13), !dbg !21
...
!1 = !DIFile(filename: "reference.cpp", directory: "/Users/marthaud/ikos/ikos-git/frontend/llvm/test/regression/import/normal_optimization")
!2 = !{}
