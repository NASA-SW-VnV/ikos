...
define i32 @main(i32, i8**) #0 !dbg !39 {
  ...
  call void @llvm.dbg.value(metadata i8** %1, metadata !47, metadata !DIExpression()), !dbg !48
  call void @llvm.dbg.declare(metadata [10 x i32]* %3, metadata !49, metadata !DIExpression()), !dbg !52
