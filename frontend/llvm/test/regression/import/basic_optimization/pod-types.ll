...
; Function Attrs: noinline nounwind ssp uwtable
define i32 @main(i32, i8**) #0 !dbg !38 {
  %3 = alloca [10 x i32], align 16
  call void @llvm.dbg.value(metadata i32 %0, i64 0, metadata !44, metadata !45), !dbg !46
  call void @llvm.dbg.value(metadata i8** %1, i64 0, metadata !47, metadata !45), !dbg !48
  call void @llvm.dbg.declare(metadata [10 x i32]* %3, metadata !49, metadata !45), !dbg !52
  %4 = bitcast [10 x i32]* %3 to i8*, !dbg !52
  call void @llvm.memset.p0i8.i64(i8* %4, i8 0, i64 40, i32 16, i1 false), !dbg !52
  %5 = bitcast i8* %4 to [10 x i32]*, !dbg !52
  %6 = getelementptr [10 x i32], [10 x i32]* %5, i32 0, i32 0, !dbg !52
  store i32 1, i32* %6, !dbg !52
  %7 = getelementptr [10 x i32], [10 x i32]* %5, i32 0, i32 1, !dbg !52
  store i32 -1, i32* %7, !dbg !52
  %8 = getelementptr [10 x i32], [10 x i32]* %5, i32 0, i32 2, !dbg !52
  store i32 255, i32* %8, !dbg !52
  %9 = getelementptr [10 x i32], [10 x i32]* %5, i32 0, i32 3, !dbg !52
  store i32 42, i32* %9, !dbg !52
  ret i32 0, !dbg !53
}
...
!3 = !DIFile(filename: "pod-types.c", directory: "/Users/marthaud/ikos/ikos-git/frontend/llvm/test/regression/import/normal_optimization")
!4 = !{}
!5 = !{!0, !6, !9, !12, !15, !19, !22}
...
!34 = distinct !DISubprogram(name: "fun", scope: !3, file: !3, line: 15, type: !35, isLocal: false, isDefinition: true, scopeLine: 15, isOptimized: false, unit: !2, variables: !4)
!35 = !DISubroutineType(types: !36)
!36 = !{null}
!37 = !DILocation(line: 15, column: 13, scope: !34)
!38 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 17, type: !39, isLocal: false, isDefinition: true, scopeLine: 17, flags: DIFlagPrototyped, isOptimized: false, unit: !2, variables: !4)
!39 = !DISubroutineType(types: !40)
!40 = !{!18, !18, !41}
!41 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !42, size: 64)
!42 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !43, size: 64)
!43 = !DIBasicType(name: "char", size: 8, encoding: DW_ATE_signed_char)
!44 = !DILocalVariable(name: "argc", arg: 1, scope: !38, file: !3, line: 17, type: !18)
!45 = !DIExpression()
!46 = !DILocation(line: 17, column: 14, scope: !38)
!47 = !DILocalVariable(name: "argv", arg: 2, scope: !38, file: !3, line: 17, type: !41)
!48 = !DILocation(line: 17, column: 27, scope: !38)
!49 = !DILocalVariable(name: "xxx", scope: !38, file: !3, line: 18, type: !50)
!50 = !DICompositeType(tag: DW_TAG_array_type, baseType: !18, size: 320, elements: !51)
!51 = !{!27}
!52 = !DILocation(line: 18, column: 7, scope: !38)
