...
; CHECK:   si8* %5 = ptrshift %4, 8 * 0
; CHECK:   void (si8*, si32)** %6 = bitcast %5
; CHECK:   void (si8*, si32)* %7 = load %6, align 8
; CHECK:   call %7(%1, 12)
; CHECK:   si8* %8 = bitcast %1
; CHECK:   si8** %9 = bitcast %8
; CHECK:   si8* %10 = load %9, align 8
; CHECK:   si8* %11 = ptrshift %10, 8 * 1
; CHECK:   si32 (si8*)** %12 = bitcast %11
; CHECK:   si32 (si8*)* %13 = load %12, align 8
; CHECK:   si32 %14 = call %13(%1)
; CHECK:   call @_Z1hi(14)
; CHECK:   si32 %15 = call @_Z2hhi(15)
; CHECK:   return
; CHECK: }
; CHECK: }
...
; CHECK:   {0: si32 ()**}* %11 = bitcast %10
; CHECK:   call @ar.libcpp.endcatch()
; CHECK: }
; CHECK: #9 predecessors={#6} successors={#unified-exit} {
; CHECK:   %7 sine %9
; CHECK:   {0: si8*, 8: si32} %12 = insertelement undef, 0, %6
; CHECK:   {0: si8*, 8: si32} %13 = insertelement %12, 8, %7
; CHECK:   resume %13
; CHECK: }
