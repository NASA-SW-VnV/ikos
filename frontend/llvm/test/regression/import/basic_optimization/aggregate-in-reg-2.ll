; ModuleID = 'aggregate-in-reg-2.cpp.pp.bc'
...
define i32 @main() #1 !dbg !28 {
  ...
  %12 = getelementptr inbounds [4 x i8], [4 x i8]* @.str, i32 0, i32 0, !dbg !35
...
!8 = distinct !DISubprogram(name: "f", linkageName: "_Z1ff", scope: !1, file: !1, line: 12, type: !9, isLocal: false, isDefinition: true, scopeLine: 12, flags: DIFlagPrototyped, isOptimized: false, unit: !0, retainedNodes: !2)
!9 = !DISubroutineType(types: !10)
!10 = !{!11, !19}
!11 = !DIDerivedType(tag: DW_TAG_typedef, name: "line_t", file: !1, line: 10, baseType: !12)
!12 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !1, line: 8, size: 128, flags: DIFlagTypePassByValue | DIFlagTrivial, elements: !13, identifier: "_ZTS6line_t")
!13 = !{!14, !21}
...
!16 = distinct !DICompositeType(tag: DW_TAG_structure_type, file: !1, line: 3, size: 64, flags: DIFlagTypePassByValue | DIFlagTrivial, elements: !17, identifier: "_ZTS5pos_t")
!17 = !{!18, !20}
...
!28 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 16, type: !29, isLocal: false, isDefinition: true, scopeLine: 16, flags: DIFlagPrototyped, isOptimized: false, unit: !0, retainedNodes: !2)
