...
; <label>:1:                                      ; preds = %0, %1
  %2 = getelementptr inbounds [13 x i8], [13 x i8]* @.str, i32 0, i32 0, !dbg !12
  %3 = call i32 (i8*, ...) @printf(i8* %2), !dbg !12
  br label %1, !dbg !14, !llvm.loop !16
}
...
!1 = !DIFile(filename: "non-term-2.c", directory: "/Users/marthaud/ikos/ikos-git/frontend/llvm/test/regression/import/normal_optimization")
!2 = !{}
