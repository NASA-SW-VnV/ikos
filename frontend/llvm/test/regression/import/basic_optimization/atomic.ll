...
; CHECK:   si32 %2 = load volatile %1, align 4
; CHECK:   return %2
; CHECK: }
; CHECK: }
...
!2 = distinct !DICompileUnit(language: DW_LANG_C99, file: !3, producer: "clang version 7.0.0 (tags/RELEASE_700/final)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !4, retainedTypes: !5, globals: !7)
...
!15 = !{!"clang version 7.0.0 (tags/RELEASE_700/final)"}
!16 = distinct !DISubprogram(name: "main", scope: !3, file: !3, line: 3, type: !17, isLocal: false, isDefinition: true, scopeLine: 3, isOptimized: false, unit: !2, retainedNodes: !4)
