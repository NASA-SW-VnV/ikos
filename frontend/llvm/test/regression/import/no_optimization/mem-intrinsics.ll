...
; CHECK:   si8** %7 = bitcast $2
; CHECK:   si8* %8 = load %7, align 8
; CHECK:   si8* %9 = bitcast %8
; CHECK:   call @ar.memcpy(%6, %9, 10, 4, 4, 0)
; CHECK:   si32* %10 = bitcast %6
; CHECK:   store $3, %10, align 8
; CHECK:   si8** %11 = bitcast $1
; CHECK:   si8* %12 = load %11, align 8
; CHECK:   si8* %13 = bitcast %12
; CHECK:   si8** %14 = bitcast $2
; CHECK:   si8* %15 = load %14, align 8
; CHECK:   si8* %16 = bitcast %15
; CHECK:   call @ar.memmove(%13, %16, 50, 4, 4, 0)
; CHECK:   si32* %17 = bitcast %13
; CHECK:   store $3, %17, align 8
; CHECK:   si8** %18 = bitcast $1
; CHECK:   si8* %19 = load %18, align 8
; CHECK:   si8* %20 = bitcast %19
; CHECK:   call @ar.memset(%20, 1, 50, 4, 0)
; CHECK:   si32* %21 = bitcast %20
; CHECK:   store $3, %21, align 8
; CHECK:   return 0
; CHECK: }
; CHECK: }
