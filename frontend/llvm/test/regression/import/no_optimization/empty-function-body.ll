; ModuleID = 'empty-function-body.c.pp.bc'
...
define void @GEN2_w_test2_terminate() #0 !dbg !7 {
  ret void, !dbg !10
}
...
!7 = distinct !DISubprogram(name: "GEN2_w_test2_terminate", scope: !1, file: !1, line: 1, type: !8, isLocal: false, isDefinition: true, scopeLine: 1, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
