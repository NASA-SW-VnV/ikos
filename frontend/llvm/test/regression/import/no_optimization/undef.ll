...
define i32 @main(i32, i8**) #0 !dbg !7 {
  ...
  call void @llvm.dbg.declare(metadata i32** %6, metadata !19, metadata !15), !dbg !21
...
!19 = !DILocalVariable(name: "v", scope: !7, file: !1, line: 4, type: !20)
...
!24 = !DILocation(line: 5, column: 17, scope: !7)
!25 = !DILocation(line: 5, column: 15, scope: !7)
