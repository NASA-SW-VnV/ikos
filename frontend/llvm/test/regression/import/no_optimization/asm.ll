...
define i32 @main() #0 !dbg !7 {
  ...
  %5 = call i32 asm "mov $1, $0\0A\09add $$1, $0", "=r,r,~{dirflag},~{fpsr},~{flags}"(i32 %4) #1, !dbg !17, !srcloc !18
