...
!9 = distinct !DICompositeType(tag: DW_TAG_class_type, name: "Base", file: !3, line: 1, size: 64, elements: !10, identifier: "_ZTS4Base")
!10 = !{!11, !13}
...
!15 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "Mixin", file: !3, line: 7, size: 32, elements: !16, identifier: "_ZTS5Mixin")
!16 = !{!17}
...
!20 = distinct !DICompositeType(tag: DW_TAG_structure_type, name: "Empty", file: !3, line: 12, size: 8, elements: !21, identifier: "_ZTS5Empty")
!21 = !{!22}
!22 = !DISubprogram(name: "f", linkageName: "_ZN5Empty1fEv", scope: !20, file: !3, line: 13, type: !23, isLocal: false, isDefinition: false, scopeLine: 13, flags: DIFlagPrototyped, isOptimized: false)
