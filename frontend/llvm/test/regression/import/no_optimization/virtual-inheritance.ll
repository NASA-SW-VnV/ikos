...
define linkonce_odr void @_ZN1DC1Ev(%struct.D*) unnamed_addr #2 align 2 !dbg !76 {
  ...
  call void @llvm.dbg.declare(metadata %struct.D** %2, metadata !81, metadata !37), !dbg !83
...
define linkonce_odr void @_ZN1E1fEv(%struct.E*) unnamed_addr #2 align 2 !dbg !114 {
  ...
  call void @llvm.dbg.declare(metadata %struct.E** %2, metadata !115, metadata !37), !dbg !116
...
define linkonce_odr void @_ZN1EC1Ev(%struct.E*) unnamed_addr #2 align 2 !dbg !70 {
  %2 = alloca %struct.E*, align 8
  store %struct.E* %0, %struct.E** %2, align 8
  call void @llvm.dbg.declare(metadata %struct.E** %2, metadata !72, metadata !37), !dbg !74
  %3 = load %struct.E*, %struct.E** %2, align 8
...
define linkonce_odr void @_ZN1FC1Ev(%struct.F*) unnamed_addr #2 align 2 !dbg !85 {
  ...
  call void @llvm.dbg.declare(metadata %struct.F** %2, metadata !90, metadata !37), !dbg !92
...
define linkonce_odr void @_ZN1FC2Ev(%struct.F*, i8**) unnamed_addr #2 align 2 !dbg !118 {
  ...
  call void @llvm.dbg.declare(metadata %struct.F** %3, metadata !119, metadata !37), !dbg !120
  store i8** %1, i8*** %4, align 8
  call void @llvm.dbg.declare(metadata i8*** %4, metadata !121, metadata !37), !dbg !120
  %5 = load %struct.F*, %struct.F** %3, align 8
  %6 = load i8**, i8*** %4, align 8
  %7 = load i8*, i8** %6, align 8, !dbg !124
  %8 = bitcast %struct.F* %5 to i32 (...)***, !dbg !124
  %9 = bitcast i8* %7 to i32 (...)**, !dbg !124
  store i32 (...)** %9, i32 (...)*** %8, align 8, !dbg !124
  ret void, !dbg !124
}
...
define linkonce_odr void @_ZN1GC1Ev(%struct.G*) unnamed_addr #2 align 2 !dbg !94 {
  ...
  call void @llvm.dbg.declare(metadata %struct.G** %2, metadata !99, metadata !37), !dbg !101
...
define linkonce_odr void @_ZN1GC2Ev(%struct.G*, i8**) unnamed_addr #2 align 2 !dbg !125 {
  ...
  call void @llvm.dbg.declare(metadata %struct.G** %3, metadata !126, metadata !37), !dbg !127
  store i8** %1, i8*** %4, align 8
  call void @llvm.dbg.declare(metadata i8*** %4, metadata !128, metadata !37), !dbg !127
  %5 = load %struct.G*, %struct.G** %3, align 8
  %6 = load i8**, i8*** %4, align 8
  %7 = load i8*, i8** %6, align 8, !dbg !129
  %8 = bitcast %struct.G* %5 to i32 (...)***, !dbg !129
  %9 = bitcast i8* %7 to i32 (...)**, !dbg !129
  store i32 (...)** %9, i32 (...)*** %8, align 8, !dbg !129
  ret void, !dbg !129
}
...
define linkonce_odr void @_ZN1HC1Ev(%struct.H*) unnamed_addr #2 align 2 !dbg !103 {
  ...
  call void @llvm.dbg.declare(metadata %struct.H** %2, metadata !108, metadata !37), !dbg !110
  ...
  %12 = getelementptr inbounds [4 x i8*], [4 x i8*]* @_ZTT1H, i64 0, i64 2, !dbg !112
  call void @_ZN1GC2Ev(%struct.G* %11, i8** %12) #3, !dbg !112
...
define i32 @main() #0 !dbg !7 {
  ...
  call void @llvm.dbg.declare(metadata %struct.E* %2, metadata !11, metadata !37), !dbg !38
  call void @_ZN1EC1Ev(%struct.E* %2) #3, !dbg !38
  call void @llvm.dbg.declare(metadata %struct.D* %3, metadata !39, metadata !37), !dbg !48
  call void @_ZN1DC1Ev(%struct.D* %3) #3, !dbg !48
  call void @llvm.dbg.declare(metadata %struct.F* %4, metadata !49, metadata !37), !dbg !55
  call void @_ZN1FC1Ev(%struct.F* %4) #3, !dbg !55
  call void @llvm.dbg.declare(metadata %struct.G* %5, metadata !56, metadata !37), !dbg !62
  call void @_ZN1GC1Ev(%struct.G* %5) #3, !dbg !62
  call void @llvm.dbg.declare(metadata %struct.H* %6, metadata !63, metadata !37), !dbg !68
