...
define i32 @foo(i32, i32) #0 !dbg !11 {
  ...
  call void @llvm.dbg.declare(metadata i32* %5, metadata !19, metadata !15), !dbg !20
  %7 = load i32, i32* %3, align 4, !dbg !21
  %8 = load i32, i32* %4, align 4, !dbg !22
  %9 = sub nsw i32 %7, %8, !dbg !23
  store i32 %9, i32* %5, align 4, !dbg !20
  call void @llvm.dbg.declare(metadata i32* %6, metadata !24, metadata !15), !dbg !25
...
; <label>:12:                                     ; preds = %2
  ...
  br i1 %14, label %15, label %19, !dbg !32

; <label>:15:                                     ; preds = %12
  %16 = load i32, i32* %3, align 4, !dbg !34
  %17 = load i32, i32* %4, align 4, !dbg !35
  %18 = add nsw i32 %16, %17, !dbg !36
  store i32 %18, i32* %6, align 4, !dbg !37
  br label %23, !dbg !38

; <label>:19:                                     ; preds = %12, %2
  %20 = load i32, i32* %3, align 4, !dbg !39
  %21 = load i32, i32* %4, align 4, !dbg !40
  %22 = mul nsw i32 %20, %21, !dbg !41
  store i32 %22, i32* %6, align 4, !dbg !42
  br label %23

; <label>:23:                                     ; preds = %19, %15
  %24 = load i32, i32* %6, align 4, !dbg !43
  %25 = mul nsw i32 %24, 42, !dbg !44
  ret i32 %25, !dbg !45
}
...
!19 = !DILocalVariable(name: "z", scope: !11, file: !3, line: 4, type: !6)
!20 = !DILocation(line: 4, column: 7, scope: !11)
!21 = !DILocation(line: 4, column: 11, scope: !11)
!22 = !DILocation(line: 4, column: 15, scope: !11)
!23 = !DILocation(line: 4, column: 13, scope: !11)
!24 = !DILocalVariable(name: "a", scope: !11, file: !3, line: 5, type: !6)
!25 = !DILocation(line: 5, column: 7, scope: !11)
!26 = !DILocation(line: 6, column: 7, scope: !27)
!27 = distinct !DILexicalBlock(scope: !11, file: !3, line: 6, column: 7)
!28 = !DILocation(line: 6, column: 9, scope: !27)
!29 = !DILocation(line: 6, column: 14, scope: !27)
!30 = !DILocation(line: 6, column: 17, scope: !31)
!31 = !DILexicalBlockFile(scope: !27, file: !3, discriminator: 1)
!32 = !DILocation(line: 6, column: 7, scope: !33)
!33 = !DILexicalBlockFile(scope: !11, file: !3, discriminator: 1)
!34 = !DILocation(line: 7, column: 9, scope: !27)
!35 = !DILocation(line: 7, column: 13, scope: !27)
!36 = !DILocation(line: 7, column: 11, scope: !27)
!37 = !DILocation(line: 7, column: 7, scope: !27)
!38 = !DILocation(line: 7, column: 5, scope: !27)
!39 = !DILocation(line: 9, column: 9, scope: !27)
!40 = !DILocation(line: 9, column: 13, scope: !27)
!41 = !DILocation(line: 9, column: 11, scope: !27)
!42 = !DILocation(line: 9, column: 7, scope: !27)
!43 = !DILocation(line: 10, column: 10, scope: !11)
!44 = !DILocation(line: 10, column: 12, scope: !11)
!45 = !DILocation(line: 10, column: 3, scope: !11)
