...
define i32 @main(i32, i8**) local_unnamed_addr #0 !dbg !16 {
  ...
  call void @llvm.dbg.value(metadata <4 x float> <float 1.000000e+00, float 2.000000e+00, float 3.000000e+00, float 4.000000e+00>, metadata !27, metadata !DIExpression()), !dbg !28
  call void @llvm.dbg.value(metadata <4 x float> <float 4.000000e+00, float 3.000000e+00, float 2.000000e+00, float 1.000000e+00>, metadata !27, metadata !DIExpression()), !dbg !28
  call void @printv(<4 x float> <float 4.000000e+00, float 3.000000e+00, float 2.000000e+00, float 1.000000e+00>) #3, !dbg !29
  ret i32 0, !dbg !30
}
...
!5 = !DIFile(filename: "/Users/marthaud/Homebrew/Cellar/llvm/7.0.1/lib/clang/7.0.1/include/xmmintrin.h", directory: "/Users/marthaud/ikos/ikos-git/frontend/llvm/test/regression/import/aggressive_optimization")
