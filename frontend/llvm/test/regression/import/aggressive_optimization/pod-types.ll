...
define i32 @main(i32, i8**) local_unnamed_addr #0 !dbg !35 {
  ...
  call void @llvm.dbg.value(metadata i8** %1, metadata !43, metadata !DIExpression()), !dbg !44
  call void @llvm.dbg.value(metadata i32 0, metadata !45, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 32)), !dbg !48
  call void @llvm.dbg.value(metadata i32 0, metadata !45, metadata !DIExpression(DW_OP_LLVM_fragment, 32, 32)), !dbg !48
  call void @llvm.dbg.value(metadata i32 0, metadata !45, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 32)), !dbg !48
  call void @llvm.dbg.value(metadata i32 0, metadata !45, metadata !DIExpression(DW_OP_LLVM_fragment, 96, 32)), !dbg !48
  call void @llvm.dbg.value(metadata i32 1, metadata !45, metadata !DIExpression(DW_OP_LLVM_fragment, 0, 32)), !dbg !48
  call void @llvm.dbg.value(metadata i32 -1, metadata !45, metadata !DIExpression(DW_OP_LLVM_fragment, 32, 32)), !dbg !48
  call void @llvm.dbg.value(metadata i32 255, metadata !45, metadata !DIExpression(DW_OP_LLVM_fragment, 64, 32)), !dbg !48
  call void @llvm.dbg.value(metadata i32 42, metadata !45, metadata !DIExpression(DW_OP_LLVM_fragment, 96, 32)), !dbg !48
  ret i32 0, !dbg !49
}
...
!0 = distinct !DICompileUnit(language: DW_LANG_C99, file: !1, producer: "clang version 6.0.1 (tags/RELEASE_601/final)", isOptimized: false, runtimeVersion: 0, emissionKind: FullDebug, enums: !2, globals: !3)
...
!35 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 17, type: !36, isLocal: false, isDefinition: true, scopeLine: 17, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
...
!42 = !DILocation(line: 17, column: 14, scope: !35)
!43 = !DILocalVariable(name: "argv", arg: 2, scope: !35, file: !1, line: 17, type: !38)
!44 = !DILocation(line: 17, column: 27, scope: !35)
!45 = !DILocalVariable(name: "xxx", scope: !35, file: !1, line: 18, type: !46)
!46 = !DICompositeType(tag: DW_TAG_array_type, baseType: !19, size: 320, elements: !47)
!47 = !{!28}
!48 = !DILocation(line: 18, column: 7, scope: !35)
!49 = !DILocation(line: 19, column: 3, scope: !35)
