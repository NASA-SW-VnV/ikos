...
define i32 @main() local_unnamed_addr #0 !dbg !32 {
  %1 = getelementptr inbounds [4 x i8], [4 x i8]* @.str.2, i64 0, i64 0, !dbg !35
  %2 = call i32 (i8*, ...) @printf(i8* %1, i32 6), !dbg !35
  ret i32 %2, !dbg !36
}
...
!32 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 21, type: !33, isLocal: false, isDefinition: true, scopeLine: 21, flags: DIFlagPrototyped, isOptimized: false, unit: !0, variables: !2)
!33 = !DISubroutineType(types: !34)
!34 = !{!22}
!35 = !DILocation(line: 22, column: 10, scope: !32)
!36 = !DILocation(line: 22, column: 3, scope: !32)
