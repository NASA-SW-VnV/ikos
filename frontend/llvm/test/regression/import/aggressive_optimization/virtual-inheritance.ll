...
define i32 @main() local_unnamed_addr #0 !dbg !8 {
  ...
  call void @llvm.dbg.value(metadata %struct.D* %2, metadata !39, metadata !DIExpression(DW_OP_deref)), !dbg !48
  call fastcc void @_ZN1DC1Ev(%struct.D* nonnull %2) #3, !dbg !48
  call void @llvm.dbg.value(metadata %struct.F* %3, metadata !49, metadata !DIExpression(DW_OP_deref)), !dbg !55
  call fastcc void @_ZN1FC1Ev(%struct.F* nonnull %3) #3, !dbg !55
  call void @llvm.dbg.value(metadata %struct.G* %4, metadata !56, metadata !DIExpression(DW_OP_deref)), !dbg !62
  call fastcc void @_ZN1GC1Ev(%struct.G* nonnull %4) #3, !dbg !62
  call void @llvm.dbg.value(metadata %struct.H* %5, metadata !63, metadata !DIExpression(DW_OP_deref)), !dbg !68
