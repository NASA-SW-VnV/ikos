...
; CHECK: #1 !entry !exit {
; CHECK:   si8* %2 = ptrshift %1, 32 * 0, 1 * 0
...
; CHECK:   si64* %4 = bitcast %3
; CHECK:   si64 %5 = load %4, align 8
; CHECK:   si64* %6 = bitcast %1
...
; CHECK: #1 !entry !exit {
; CHECK:   si8* %2 = ptrshift %1, 24 * 0, 1 * 0
