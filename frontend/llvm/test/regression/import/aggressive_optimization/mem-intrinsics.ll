...
define i32 @main() local_unnamed_addr #0 !dbg !11 {
  call void @llvm.memset.p0i8.i64(i8* undef, i8 1, i64 50, i32 4, i1 false), !dbg !14
  ret i32 0, !dbg !15
}
...
!11 = distinct !DISubprogram(name: "main", scope: !1, file: !1, line: 8, type: !12, isLocal: false, isDefinition: true, scopeLine: 8, isOptimized: false, unit: !0, variables: !2)
!12 = !DISubroutineType(types: !13)
!13 = !{!5}
!14 = !DILocation(line: 12, column: 13, scope: !11)
