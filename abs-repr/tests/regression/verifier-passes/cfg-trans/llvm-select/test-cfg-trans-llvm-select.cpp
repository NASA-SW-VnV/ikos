...
void Verifier::nodeStart(AR_Function& f) {
  std::string trans =
    ...
    ($edge ($*_entry_split_select_false) ($*out_entry_merge_select)) \
    ($edge ($*_entry_split_select_true) ($*out_entry_merge_select)) \
    ($edge ($*out_entry_merge_icmp) ($*_entry_split_select_true)) \
    ($edge ($*out_entry_merge_icmp) ($*_entry_split_select_false)) \
  ...
  assert((*(*body).getExitBlock()).getNameId() == "*out_entry_merge_select");
  ...
  AR_Node_Ref< AR_Basic_Block > select_true =
      (*body).getBasicBlockByNameId("*_entry_split_select_true");
  ...
  assert((*(*assign).getLeftOperand()).getName() == "cond");
  ...
  AR_Node_Ref< AR_Basic_Block > select_false =
      (*body).getBasicBlockByNameId("*_entry_split_select_false");
