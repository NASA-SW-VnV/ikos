...
void Verifier::nodeStart(AR_Function& f) {
  ...
  for (; b != bblocks.end(); b++) {
    if ((**b).getNameId() == "entry") {
      next_bblocks = (**b).getNextBlocks();
      assert(std::distance(next_bblocks.first, next_bblocks.second) == 1);
      assert((**next_bblocks.first).getNameId() == "*in_entry_to_for.cond_phi");
    } else if ((**b).getNameId() == "*in_entry_to_for.cond_phi") {
      next_bblocks = (**b).getNextBlocks();
      assert(std::distance(next_bblocks.first, next_bblocks.second) == 1);
      assert((**next_bblocks.first).getNameId() == "for.cond");
    } else if ((**b).getNameId() == "*in_for.inc_to_for.cond_phi") {
      next_bblocks = (**b).getNextBlocks();
      assert(std::distance(next_bblocks.first, next_bblocks.second) == 1);
      assert((**next_bblocks.first).getNameId() == "for.cond");
    } else if ((**b).getNameId() == "for.cond") {
      next_bblocks = (**b).getNextBlocks();
      ...
      if (bb0_name == "*out_for.cond_to_for.end_icmp_false")
        assert(bb1_name == "*out_for.cond_to_for.body_icmp_true");
      else if (bb0_name == "*out_for.cond_to_for.body_icmp_true")
        assert(bb1_name == "*out_for.cond_to_for.end_icmp_false");
    } else if ((**b).getNameId() == "*out_for.cond_to_for.end_icmp_false") {
      next_bblocks = (**b).getNextBlocks();
      assert(std::distance(next_bblocks.first, next_bblocks.second) == 1);
      assert((**next_bblocks.first).getNameId() == "for.end");
    } else if ((**b).getNameId() == "*out_for.cond_to_for.body_icmp_true") {
      next_bblocks = (**b).getNextBlocks();
      assert(std::distance(next_bblocks.first, next_bblocks.second) == 1);
      assert((**next_bblocks.first).getNameId() == "for.body");
    } else if ((**b).getNameId() == "for.inc") {
      next_bblocks = (**b).getNextBlocks();
      assert(std::distance(next_bblocks.first, next_bblocks.second) == 1);
      assert((**next_bblocks.first).getNameId() ==
             "*in_for.inc_to_for.cond_phi");
    } else if ((**b).getNameId() == "for.body") {
      next_bblocks = (**b).getNextBlocks();
      assert(std::distance(next_bblocks.first, next_bblocks.second) == 1);
      assert((**next_bblocks.first).getNameId() == "for.inc");
    }

    assert((*(*body).getEntryBlock()).getNameId() == "entry");
    assert((*(*body).getExitBlock()).getNameId() == "for.end");
  }
}
}
