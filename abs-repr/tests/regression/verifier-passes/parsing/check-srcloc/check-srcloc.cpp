...
void Verifier::nodeStart(AR_Store_Element& store_element) {
  verify_srcline(AR_Node_Ref< AR_Statement >(store_element.getUID()));
}

void Verifier::nodeStart(AR_Load_Element& load_element) {
  verify_srcline(AR_Node_Ref< AR_Statement >(load_element.getUID()));
}
