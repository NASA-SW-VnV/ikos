...
enum AR_CLASS_TYPE_CODE {
  ...
  AR_UNWIND_STATEMENT_CLASS_TYPE,
...
/**
 * AR_Unwind causes execution of the current function to immediately halt.
 * See llvm unwind instruction for more details.
 */
class AR_Unwind : public AR_Statement {
private:
  AR_Unwind(index64_t parent_bblock, s_expression);
...
public:
  ...
  virtual void nodeEnd(AR_Unwind& unwind) {}
