...
public:
  ...
  bool operator!=(z_number x) { return this->_n != x._n; }

  bool operator<(const z_number x) const { return this->_n < x._n; }
  ...
  z_number operator&(z_number x) { return z_number(this->_n & x._n); }
...
public:
  ...
  bool operator!=(q_number x) { return this->_n != x._n; }

  bool operator<(const q_number x) const { return this->_n < x._n; }
  ...
  z_number numerator() { return z_number(this->_n.get_num()); }

  z_number denominator() { return z_number(this->_n.get_den()); }
