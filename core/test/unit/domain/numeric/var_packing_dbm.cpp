...
BOOST_AUTO_TEST_CASE(narrowing_threshold) {
  ...
  BOOST_CHECK((VarPackingDBM::bottom().narrowing_threshold(VarPackingDBM::top(),
                                                           ZNumber(10)) ==
               VarPackingDBM::bottom()));
  BOOST_CHECK(
      (VarPackingDBM::bottom().narrowing_threshold(VarPackingDBM::bottom(),
                                                   ZNumber(10)) ==
       VarPackingDBM::bottom()));
  BOOST_CHECK((VarPackingDBM::top().narrowing_threshold(VarPackingDBM::top(),
                                                        ZNumber(10)) ==
               VarPackingDBM::top()));
  BOOST_CHECK((VarPackingDBM::top().narrowing_threshold(VarPackingDBM::bottom(),
                                                        ZNumber(10)) ==
               VarPackingDBM::bottom()));
  ...
  BOOST_CHECK((inv1.narrowing_threshold(VarPackingDBM::bottom(), ZNumber(10)) ==
               VarPackingDBM::bottom()));
  BOOST_CHECK(
      (VarPackingDBM::top().narrowing_threshold(inv1, ZNumber(10)) == inv1));
  BOOST_CHECK((VarPackingDBM::bottom().narrowing_threshold(inv1, ZNumber(10)) ==
               VarPackingDBM::bottom()));
