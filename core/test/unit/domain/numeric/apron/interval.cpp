/*******************************************************************************
 *
 * Tests for ApronDomain with Domain = Interval
 *
...
BOOST_AUTO_TEST_CASE(add) {
  ...
  BOOST_CHECK(inv.to_interval(x) == Interval(Bound(1), Bound::plus_infinity()));
  BOOST_CHECK(inv.to_interval(y) == Interval(Bound(6), Bound::plus_infinity()));
  BOOST_CHECK(inv.to_interval(z) ==
              Interval(Bound(11), Bound::plus_infinity()));
  ...
  BOOST_CHECK(inv.to_interval(x) == Interval(Bound(1), Bound(9)));
  BOOST_CHECK(inv.to_interval(y) == Interval(Bound(6), Bound(6)));
  BOOST_CHECK(inv.to_interval(z) == Interval(Bound(18), Bound(19)));

  inv.add(VariableExpr(x) == VariableExpr(y));
  BOOST_CHECK(inv.to_interval(x) == Interval(Bound(6), Bound(6)));
  BOOST_CHECK(inv.to_interval(y) == Interval(Bound(6), Bound(6)));
  BOOST_CHECK(inv.to_interval(z) == Interval(Bound(18), Bound(19)));
