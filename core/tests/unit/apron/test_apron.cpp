...
typedef patricia_tree_set< z_var > variable_set_t;
...
//typedef apron_domain< apron::pkgrid_polyhedra_lin_congruences, z_number, varname_t > domain_t;
typedef apron_domain< apron::polka_polyhedra, z_number, varname_t > domain_t;
//typedef apron_domain< apron::ppl_linear_congruences, z_number, varname_t > domain_t;
//typedef apron_domain< apron::pkgrid_polyhedra_lin_congruences, z_number, varname_t > domain_t;
