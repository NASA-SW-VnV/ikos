...
void test1() {
  ...
  cout << s << endl;
  s.solve();
  cout << "f_ptr = " << s.get(f_ptr) << endl;
  cout << "p = " << s.get(p) << endl;
  cout << "q = " << s.get(q) << endl;
  cout << "tmp = " << s.get(tmp) << endl;
}
...
void test2() {
  ...
  cout << s << endl;
  s.solve();
  cout << "*p = " << s.get(p_content) << endl;
  cout << "*q = " << s.get(q_content) << endl;
}
...
void test3() {
  ...
  s.solve();
  cout << "p5 = " << s.get(p5) << endl;   //({25}, [0, 0])
  cout << "p8 = " << s.get(p8) << endl;   //({25}, [0, 0])
  cout << "p11 = " << s.get(p11) << endl; //({25}, [4, 4])
}
