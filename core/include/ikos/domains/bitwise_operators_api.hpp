 ...
 *
 * \file
 * \brief Generic API for bitwise operations.
 *
...
/// \brief Base class for abstract domains supporting bitwise operators
template < typename Number, typename VariableName >
class bitwise_operators {
public:
  /// \brief Apply x = op y (from: bit-width, to: bit-width)
  virtual void apply(conv_operation_t op,
                     VariableName x,
                     VariableName y,
                     uint64_t from,
                     uint64_t to) = 0;
