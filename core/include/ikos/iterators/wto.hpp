  ...
  private:
    ...
    wto_component_t& dereference() const {
      if (this->_it != this->_l->end()) {
        ...
        throw ikos_error("WTO cycle: trying to dereference an empty iterator");
      }
    }
...
private:
  ...
  NodeName pop() {
    if (this->_stack->empty()) {
      throw ikos_error("WTO computation: empty stack");
    } else {
  ...
  private:
    ...
    wto_component_t& dereference() const {
      if (this->_it != this->_l->end()) {
        ...
        throw ikos_error("WTO: trying to dereference an empty iterator");
      }
    }
