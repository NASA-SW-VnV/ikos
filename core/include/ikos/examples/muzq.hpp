/*******************************************************************************
 *
 * muZQ is a micro language for semantic modeling over integer and rational
 * numbers.
 *
  ...
  private:
    ...
    basic_block_t& dereference() const {
      if (this->_it != this->_ids->end()) {
        ...
        throw ikos_error("muZQ cfg: trying to dereference an empty iterator");
      }
    }
