...
public:
  ...
  literal_t& operator=(const literal&) = default;
...
private:
  struct get_integer : public boost::static_visitor< Integer > {
    ...
    Integer operator()(const floating_point_lit&) const {
      throw ikos_error("literal: trying to call integer() on a floating point");
    }
    ...
    Integer operator()(const null_lit&) const {
      throw ikos_error("literal: trying to call integer() on literal null");
    }
...
private:
  struct get_floating_point : public boost::static_visitor< Float > {
    Float operator()(const integer_lit& lit) const {
      throw ikos_error(
...
private:
  struct get_var : public boost::static_visitor< VariableName > {
    VariableName operator()(const integer_lit& lit) const {
      throw ikos_error("literal: trying to call var() on an integer");
    }

    VariableName operator()(const floating_point_lit& lit) const {
      throw ikos_error("literal: trying to call var() on a floating point");
    }

    VariableName operator()(const undefined_lit&) const {
      throw ikos_error("literal: trying to call var() on literal undefined");
    }

    VariableName operator()(const null_lit&) const {
      throw ikos_error("literal: trying to call var() on literal null");
    }
