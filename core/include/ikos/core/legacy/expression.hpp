...
public:
  ...
  typedef PatriciaTreeSet< VariableName > variable_set_t;
...
template < typename VariableName, typename Number >
class expression_number final : public _expression< VariableName, Number > {
public:
...
public:
  ...
  variable_set_t variables() { return variable_set_t(); }
...
template < typename VariableName, typename Number >
class expression_variable final : public _expression< VariableName, Number > {
public:
  typedef typename _expression< VariableName, Number >::expression_visitor_ptr
      expression_visitor_ptr;
...
public:
  ...
  variable_set_t variables() { return variable_set_t{this->_v}; }
...
template < typename VariableName, typename Number >
class expression_binary_op final : public _expression< VariableName, Number > {
public:
  typedef typename _expression< VariableName, Number >::expression_visitor_ptr
      expression_visitor_ptr;
...
public:
  ...
  variable_set_t variables() {
    return this->_left->variables().join(this->_right->variables());
  }
